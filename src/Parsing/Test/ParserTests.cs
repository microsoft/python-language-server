    ...
    public class ParserTests {
        ...
        public void NamedExpressionsErrors() {
            foreach (var version in V38AndUp) {
                ...
                errors.Errors.Should().BeEquivalentTo(new[] {
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(1, 3, 1, 5)),
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(2, 11, 2, 13)),
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(3, 7, 3, 9)),
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(4, 19, 4, 21)),
                    ...
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(12, 9, 12, 11)),
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(14, 21, 14, 23)),
                    new ErrorResult("Unparenthesized named expression not allowed in this context", new SourceSpan(17, 9, 17, 11)),
                });
            }
        }
