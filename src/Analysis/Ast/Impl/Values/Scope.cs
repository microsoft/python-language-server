...
namespace Microsoft.Python.Analysis.Values {
    ...
    internal class Scope : IScope {
        ...
        private Dictionary<IScopeNode, Scope> _childScopes;
        ...
        public IScope GetChildScope(IScopeNode node) => _childScopes != null && _childScopes.TryGetValue(node, out var s) ? s : null;
        ...
        internal void AddChildScope(Scope s) => (_childScopes ?? (_childScopes = new Dictionary<IScopeNode, Scope>()))[s.Node] = s;
