...
namespace Microsoft.Python.Analysis.Modules {
    ...
    internal sealed class BuiltinsPythonModule : CompiledPythonModule, IBuiltinsPythonModule {
        ...
        private void SpecializeTypes() {
            ...
            if (_boolType != null) {
                Analysis.GlobalScope.DeclareVariable("True", _boolType, VariableSource.Builtin, this);
                Analysis.GlobalScope.DeclareVariable("False", _boolType, VariableSource.Builtin, this);
            }

            if (noneType != null) {
                Analysis.GlobalScope.DeclareVariable("None", noneType, VariableSource.Builtin, this);
            }
