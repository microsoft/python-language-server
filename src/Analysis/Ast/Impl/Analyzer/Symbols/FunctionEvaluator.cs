...
namespace Microsoft.Python.Analysis.Analyzer.Symbols {
    ...
    internal sealed class FunctionEvaluator : MemberEvaluator {
        ...
        private void DeclareParameters(bool declareVariables) {
            ...
            if (_self != null && _function.HasClassFirstArgument()) {
                ...
                if (p0 != null && !string.IsNullOrEmpty(p0.Name)) {
                    ...
                    if (declareVariables) {
                        Eval.DeclareVariable(p0.Name, new PythonInstance(_self), VariableSource.Declaration, Module, p0.NameExpression);
                    }
                    // Set parameter info.
        ...
        private void DeclareParameter(Parameter p, ParameterInfo pi) {
            ...
            Eval.DeclareVariable(p.Name, new PythonInstance(paramType), VariableSource.Declaration, Module, p.NameExpression);
        }
    }
}
