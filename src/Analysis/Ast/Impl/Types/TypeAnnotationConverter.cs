    ...
    internal sealed class TypeAnnotationConverter : TypeAnnotationConverter<IPythonType> {
        ...
        public override IPythonType Finalize(IPythonType type) {
            ...
            if (!string.IsNullOrEmpty(n)) {
                return _scope.LookupNameInScopes(n);
            }
        ...
        public override IPythonType LookupName(string name)
            => _scope.LookupNameInScopes(name, ExpressionLookup.LookupOptions.Global | ExpressionLookup.LookupOptions.Builtins);

        public override IPythonType GetTypeMember(IPythonType baseType, string member) => baseType.GetMember(member);
