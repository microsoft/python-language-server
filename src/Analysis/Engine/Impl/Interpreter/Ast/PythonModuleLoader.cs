...
namespace Microsoft.PythonTools.Interpreter.Ast {
    public static class PythonModuleLoader {
        ...
        public static IPythonModule FromFile(
            ...
            // If module is without __init__.py, create empty stream
            using (var stream = 
        ...
        public static IPythonModule FromStream(IPythonInterpreter interpreter, Stream sourceFile, string fileName, PythonLanguageVersion langVersion)
        ...
        public static IPythonModule FromTypeStub(IPythonInterpreter interpreter, string stubFile, PythonLanguageVersion langVersion, string moduleFullName) 
