...
namespace Microsoft.PythonTools.Analysis.Documentation {
    internal abstract class DocumentationBuilder {
        private const string _ellipsis = "...";
        public InformationDisplayOptions DisplayOptions { get; private set; } = DefaultDisplayOptions;

        private static InformationDisplayOptions DefaultDisplayOptions { get; } = new InformationDisplayOptions {
