...
namespace Microsoft.PythonTools.Analysis {
    ...
    public static class AnalysisValueSetExtensions {
        ...
        public static IAnalysisSet GetInstanceType(this IAnalysisSet types)
            => AnalysisSet.Create(types.SelectMany(ns => ns.PythonType.IsClassFactory ? ns : ns.GetInstanceType()));
        ...
        public static IAnalysisSet Resolve(this IAnalysisSet self, IAnalysisUnit unit) => Resolve(self, unit as AnalysisUnit, ResolutionContext.Complete, out _);
