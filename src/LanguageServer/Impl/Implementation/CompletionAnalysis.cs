...
namespace Microsoft.Python.LanguageServer.Implementation {
    class CompletionAnalysis {
        ...
        public CompletionAnalysis(
            ...
            Options = opts;
            _pathResolver = analysis.Document.Interpreter.ModuleResolution.CurrentPathResolver;
            _textBuilder = textBuilder;
            _log = log;
            _openDocument = openDocument;
            _addBrackets = completionSettings.addBrackets;

            var finder = new ExpressionFinder(Tree, new FindExpressionOptions {
                Names = true,
                Members = true,
        ...
        private IEnumerable<CompletionItem> GetModules()
            => Analysis.Document.Interpreter.ModuleResolution.GetModules().Select(ToCompletionItem);
