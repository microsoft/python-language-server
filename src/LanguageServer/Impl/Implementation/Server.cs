...
namespace Microsoft.Python.LanguageServer.Implementation {
    public sealed partial class Server : ServerBase, ILogger, IPythonLanguageServer {
        ...
        private readonly ConcurrentDictionary<string, IPythonLanguageServerExtension> _extensions;
        ...
        public Server() {
            ...
            _extensions = new ConcurrentDictionary<string, IPythonLanguageServerExtension>();
        }
