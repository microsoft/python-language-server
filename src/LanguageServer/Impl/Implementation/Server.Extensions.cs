...
namespace Microsoft.Python.LanguageServer.Implementation {
    partial class Server {
        public async Task LoadExtension(PythonAnalysisExtensionParams extension, IServiceContainer services, CancellationToken cancellationToken) {
            try {
        ...
        private async Task InvokeExtensionsAsync(Func<IPythonLanguageServerExtension, CancellationToken, Task> action, CancellationToken cancellationToken) {
